...
public class SoloFrame extends JFrame {
    ...
    public void StoryFrame(){
        //story label
        JLabel plot = new JLabel("<html><body> 2XXX年，A国地质家们在位于北纬49度58分，西经165度43分的***山脉深处发现了一种新型矿石，其具有极高的能量密度，<br>" +
    ...
    public void StoryFrame(int x){
        ...
        switch (x){
            case 1:
                ...
                break;
            case 2:
                plot.setText("<html><body>我的名字是Jack，17岁，在我很小的时候小时候父母就因意外去世了，是爷爷一直将我抚养长大。<br>" +
            ...
            case 3:
                plot.setText("<html><body>值得庆幸的是，我运气很好，直到现在也基本上只是一些皮外伤和轻微的脑震荡（可能和这种奇怪的感觉<br>" +
                        ...
                        "矿区，只要我把这最后1片矿区的矿石开采出来，我就可以永永远远的离开这个鬼地方，回家了！一定要等着我，爷爷！<br>" +
